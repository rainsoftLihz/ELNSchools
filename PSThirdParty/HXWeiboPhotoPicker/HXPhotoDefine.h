...
// 导航栏 + 状态栏 的高度
#define kNavigationBarHeight ((kDevice_Is_iPhoneX||kDevice_Is_iPhoneXMax || kDevice_Is_iPhoneXR) ? 88 : 64)
#define kStateBarHeight ((kDevice_Is_iPhoneX||kDevice_Is_iPhoneXMax || kDevice_Is_iPhoneXR) ? 44 : 20)
