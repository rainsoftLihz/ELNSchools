...
//  test
//
//  Created by leeb on 2017/7/5.
//  Copyright © 2017年 leeb. All rights reserved.
//
...
CGFloat Adapt_scaleL(CGFloat level){
    ...
    CGFloat scale_L = Adapt_PROPORTION_IPHONE_6_WIDTH;
    
    switch (kAdaptType) {
        case kAdaptTypeIPHONE4:
            scale_L = Adapt_PROPORTION_IPHONE_4_WIDTH;
            break;
        case kAdaptTypeIPHONE5:
            scale_L = Adapt_PROPORTION_IPHONE_5_WIDTH;
            break;
...
CGFloat Adapt_scaleV(CGFloat vertical){
    ...
    switch (kAdaptType) {
        case kAdaptTypeIPHONE4:
            ...
            break;
        case kAdaptTypeIPHONE5:
            scale_V = Adapt_PROPORTION_IPHONE_5_HEIGHT;
            break;
        case kAdaptTypeIPHONE6:
